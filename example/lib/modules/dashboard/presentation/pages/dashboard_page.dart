...
class DashboardPage extends StatelessWidget with FKappaSpacing {
  const DashboardPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const FKappaAppBar(title: Text('Enterprise Dashboard')),
  ...
  Widget _buildActivityCard(int index) {
    return FKappaAnimatedView(
      type: FKappaAnimationType.scale,
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(FKappaDesignTokens.radiusMedium),
              ),
